...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    try {
      ...
      const fetchUserProfile = async () => {
        try {
          const response = await fetch("https://it342-g5-collaboraid.onrender.com/api/auth/current-user", {
            headers: {
          ...
          if (response.ok) {
            ...
            if (userData.profilePicture) {
              setUserProfilePicture(`https://it342-g5-collaboraid.onrender.com${userData.profilePicture}`)
            }
          }
        } catch (error) {
  ...
  const navigation = [
    ...
    { name: "Tasks", href: "#tasks", icon: CheckSquare, badge: "", id: "tasks" },
    { name: "Messages", href: "#messages", icon: MessageSquare, badge: "", id: "messages" },
    { name: "Notifications", href: "#notifications", icon: Bell, badge: "", id: "notifications" },
    ...
    <ThemeProvider>
      <SettingsProvider>
        <div className="min-h-screen bg-muted/30">
          {/* Header */}
          <header className="fixed top-0 left-0 right-0 z-30 h-16 bg-background border-b flex items-center px-4">
            ...
            <div className="flex items-center gap-4">
              <Button variant="outline" size="icon" className="relative" onClick={() => setActiveTab("notifications")}>
                ...
                <Badge className="absolute -right-1 -top-1 h-5 w-5 justify-center rounded-full p-0"></Badge>
              </Button>
          ...
          <div className="flex">
            {/* Sidebar (desktop) */}
            <aside className="hidden lg:fixed lg:flex lg:top-15 lg:left-0 lg:h-[calc(100vh-64px)] lg:w-64 flex-col border-r bg-background z-20">
